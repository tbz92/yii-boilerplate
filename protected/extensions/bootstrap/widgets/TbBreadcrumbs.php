...
class TbBreadcrumbs extends CBreadcrumbs
{
	...
	public function run()
	{
        ...
        // Edited by Naveed to make the separator HTML markup conform with change in new version of Twitter Bootstrap.
	...
	protected function renderItem($content, $active = false)
	{
		...
		echo $content;
        // Added by Naveed to make the separator HTML markup conform with change in new version of Twitter Bootstrap.
        if (!$active)
            echo $this->separator;
        // --
		echo '</li>';
